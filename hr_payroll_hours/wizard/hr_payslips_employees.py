...
class HrPayslipEmployees(models.TransientModel):
    ...
    _description = 'Generate payslips for all selected employees (Inheritance from base)'
    ...
    def action_compute_sheet(self):
        ...
        for employee in self.env['hr.employee'].browse(data['employee_ids']):
            ...
            extended_hours_ids = [(6, 0, unlinked_extended_hours.ids)]
            res = {
                'employee_id': employee.id,
                ...
                'extended_hours_ids': extended_hours_ids,
